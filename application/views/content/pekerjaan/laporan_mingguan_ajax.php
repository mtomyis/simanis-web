                ...
                <table id="example1" class="table-bordered" style="font-size: 7pt; width: 100%">
                  ...
                  <?php
                      ...
                      if ($query->num_rows() > 0) {
                        foreach ($query->result() as $rowp) {
                          if ($rowp->bobotsdminggu > $row->bobot) {
                  ...
                  <tr class="<?php echo $warnakolom ?>">
                    ...
                    <td style="text-align: right; vertical-align: middle; padding: 4px"><!-- volume minggu ini -->
                      <form class="form-volume" action="<?php echo base_url('pekerjaan/save_edit_ajax') ?>" method="post">
                      ...
                      <?php }?>
                      <?php if($posisi = $this->session->userdata('posisi') != "0"){ ?>
                        <input style=" border:none; width:100%; ;height:100%; text-align: center;" value="<?php echo $row->volume_detail; ?>" type=number step=0.001 name="datavolume[]" placeholder="<?php echo $row->volume_detail; ?>">
                      <?php }?>
                    </td>
                    ...
                    <?php echo ""; ?>
                    <?php }?>
                    <?php if($posisi = $this->session->userdata('posisi') != "Pengawas"){ ?>
                  ...
                  <th>
                    ...
                    <?php }?>
                    <?php if($posisi = $this->session->userdata('posisi') != "0"){ ?>
                      <!-- <a class="tombol-simpan[] btn btn-success">Simpan</a> -->
                      <button class="tombol-simpan" type="submit">Save</button>
                    <?php }?>

                    <!-- <script type="text/javascript">
                      var labohkoe = ".tombol-simpan";

                      $(document).ready(function(){
                        $(labohkoe).click(function(){
                          var data = $('.form-volume').serialize();
                          $.ajax({
                            type: 'POST',
                            url: "",
                            data: data,
