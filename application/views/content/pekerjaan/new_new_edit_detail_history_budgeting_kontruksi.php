        ...
        <!-- Info boxes -->
         <div class="col-md-9 col-xs-9 col-lg-9">
            ...
            <div class="card card-primary" style="margin-top: 10px;">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form method='post' action='<?php echo base_url('pekerjaan/new_new_update_kelola_history_budget') ?>' enctype="multipart/form-data">
              ...
              <div class="row">
                ...
                <div class="card-body">
                  ...
                  <div class='form-group'>
                    <label>Surat</label>
                    <input class="form-control prc form-control-sm" value="<?= $data->surat ?>" name="surat" required>
                  </div>
                </div>
              </div>
              </div>
