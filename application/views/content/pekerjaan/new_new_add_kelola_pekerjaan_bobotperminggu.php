      ...
      <table id="example1" class="table table-bordered table-striped responsif">
        ...
        <tr>
          ...
          <td style="text-align: right; vertical-align: middle; padding: 4px"><!-- volume minggu ini -->
            ...
            <input style=" border:none; width:100%; ;height:100%; text-align: center;" type=number step=0.001 name="databobotacuan" placeholder="<?php echo $value->bobot_total_acuan; ?>">
          </td>
          <td style="text-align: center;">
            <?php echo $value->bobot_total_acuan_komulatif; ?>
          </td>
