        ...
        <!-- Info boxes -->
         <div class="col-md-5 col-xs-12 col-lg-5">
            ...
            <div class="card card-primary" style="margin-top: 10px;">
              ...
              <form method='post' action='<?php echo base_url('pekerjaan/new_aksi_upload') ?>' enctype="multipart/form-data">
                <div class="card-body">
                ...
                <div class="card-footer">
                  ...
                  <p>
                  <p>Catatan. File yang didownload ber-ekstensi *.xlsx, jadi silahkan save as file dalam bentuk ekstensi *.csv (Comma Delimited)</p>
                <p>silahkan download file format laporannya <a target="_blank" href="<?php echo base_url('upload/Format Laporan.xlsx') ?>">disini.</a> </p>
