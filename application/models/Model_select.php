...
$kab= $this->db->get_where('new_minggu',array('proyek'=>$provId));
...
$this->db->order_by('id','ASC');
$kec= $this->db->get_where('new_pekerjaan',array('pekerjaan'=>$kabId));

foreach ($kec->result_array() as $data ){
$kecamatan.= "<option value='$data[uraian_pekerjaan]'>$data[uraian_pekerjaan]</option>";
}
...
$kel= $this->db->get_where('new_minggu',array('proyek'=>$proyek));
